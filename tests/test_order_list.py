...
class TestStellarBurgersOrderList:
    ...
    def test_order_details(self, list_order):
        ...
        recovery_page.wait_element_visibility_of_element_located(ListOrderLocators.TITLE_LIST_ORDER)
        recovery_page.tap_order_list()
        recovery_page.wait_element_visibility_of_element_located(ListOrderLocators.WINDOW_ORDER)
